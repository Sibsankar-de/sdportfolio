                    ...
                    <section className='pf-nav-opt-box-cont'>
                        ...
                        <div className='pf-common-prop gap-2 pf-col-semwhite'>
                            <label className='pf-toggle-container pf-home-toogle-btn'>
                                <input type="checkbox" id='toogle-input' className='d-none' onChange={e => setToogleValue(e.target.checked)} checked={Boolean(toogleValue)} />
                                <span className='pf-toggle-slider pf-common-prop'>
                                    {toogleValue ? <i className="ri-moon-fill"></i> : <i className="ri-sun-fill"></i>}
                                </span>
                            </label>
                        </div>
