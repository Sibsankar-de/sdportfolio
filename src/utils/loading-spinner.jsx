...
export const LoadingDot = ({ width=30 }) => {
	return (
		<svg className="pl" viewBox="0 0 64 64" width="64px" height="64px" xmlns="http://www.w3.org/2000/svg" style={{ height: width, width: width }}>
			<defs>
